...
def step_volunnterrecord2( context, name, user, password, email, phone, address, cep, services ):
    ...
    user = "aongvol001"
    password = "12345"
    email = "aongvol@volunnter.com.br001"
    phone = "999999987"
...
@then('I see that the volunnter user was record as ongvolunnter')
...
def step_volunnterrecord2_2(context, name, user, password, email, phone, address, cep, services ):
    ...
    user = "bongvol001"
    password = "12345"
    email = "bongvol@volunnter.com.br001"
    phone = "999999987"
    address = "rua joão firmino Régis"
    cep = "57626217"
    services = "corte de cabelo"
...
def step_volunnterrecord3_2( context, name, user, password, email, phone, address, cep, services ):
    ...
    user = "congvol001"
    password = "12345"
    email = "congvol@volunnter.com.br001"
    phone = "999999987"
    address = "rua joão firmino Régis"
    cep = "57626217"
    services = "corte de cabelo"
